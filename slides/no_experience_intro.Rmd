---
title: "An Introduction to Reproducible Analyses in R: Without previous experience."
...
`tidyverse` is already installed in on these computers but we need to load it (add it to our library) before we can use it in a session.
...
.pull-right[
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#285169", color = "white", bold = TRUE)`  Can you use the manual to change to colour of the lines around each bar to black?]]
--
...
.pull-right[
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#285169", color = "white", bold = TRUE)`  Look up `scale_x_discrete` in the manual and work out how to change "n" to "Number of Males"]
]
...
pigeon2 <- gather(data = pigeon, key = population, value = distance)
str(pigeon2)
```
...
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#285169", color = "white", bold = TRUE)`  Add a column for the standard devation

`r kableExtra::text_spec("Extra exercise:", background = "#285169", color = "white", bold = TRUE)`  Add a column for the standard error given by $\frac{s.d.}{\sqrt{n}}$
...
.pull-right[
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#285169", color = "white", bold = TRUE)`  Can you remember how to make the axes cross at (0,0)]
]
---
background-image: url(../pics/interorbital.png)
background-position: 100% 0%
...
.pull-right[
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#285169", color = "white", bold = TRUE)`  Can you (gratuitously) colour the boxes by population too?]
]
