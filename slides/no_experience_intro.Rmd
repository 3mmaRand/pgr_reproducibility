...
# Introduction to Reproducibility in R <BR> For those without previous experience.
...
.pull-right[
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#333880", color = "white", bold = TRUE)`  Can you use the manual to change to colour of the lines around each bar to black?]]
--
...
.pull-right[
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#333880", color = "white", bold = TRUE)`  Look up `scale_x_discrete` in the manual and work out how to change "n" to "Number of Males"]
]
...
.footnote[
`r kableExtra::text_spec("Extra exercise:", background = "#333880", color = "white", bold = TRUE)`  Add a column for the standard devation

`r kableExtra::text_spec("Extra exercise:", background = "#333880", color = "white", bold = TRUE)`  Add a column for the standard error given by $\frac{s.d.}{\sqrt{n}}$
